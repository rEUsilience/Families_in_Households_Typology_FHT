...
use "$DATA/BE_euromod_mother.dta", clear

merge m:1 pid hid /*country year*/ using "$DATA/BE_euromod_father.dta", keep(1 3) // this dataset was created in "REU_SILC_CS_hhcomp_fathers.do"
drop _merge 
...
save "$DATA/BE_euromod_parents.dta", replace
